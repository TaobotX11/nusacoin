...
By default, nusacoind will dump mempool on shutdown and
...
class MempoolPersistTest(NusacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nusacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
