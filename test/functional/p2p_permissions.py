...
class P2PPermissionsTests(NusacoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].nusacoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].nusacoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
