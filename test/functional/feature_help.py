...
"""Verify that starting nusacoin with -h works as expected."""

from test_framework.test_framework import NusacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(NusacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nusacoin with -h for help text")
        ...
        self.log.info("Start nusacoin with -version for version information")
        ...
        self.log.info("Start nusacoind with -fakearg to make sure it does not start")
