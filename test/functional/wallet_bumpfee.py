...
class BumpFeeTest(NusacoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 btc (100,000 nuoshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "nu/B", "NUX/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 350.25 nu/vB vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 NUX / 1000 vbytes = 0.00049385 NUX.
    # or occasionally 140 vbytes * fee_rate 0.00350250 NUX / 1000 vbytes = 0.00049035 NUX.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 NUX.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 NUX / 1000 vbytes = 0.00002820 NUX
