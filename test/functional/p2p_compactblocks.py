...
# TestP2PConn: A peer we use to send messages to nusacoind, and store responses.
...
class CompactBlocksTest(NusacoinTestFramework):
    ...
    # This test actually causes nusacoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nusacoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for nusacoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # nusacoind will not send blocktxn responses for blocks whose height is
