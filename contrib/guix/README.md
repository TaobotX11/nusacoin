# Bootstrappable Nusacoin Core Builds

This directory contains the files necessary to perform bootstrappable Nusacoin
Core builds.
...
- 24GB of free disk space on the partition that the Nusacoin Core git repository
  resides in
...
For a Nusacoin Core depends development environment, simply invoke
...
From the top of a clean Nusacoin Core repository:
...
To use dongcarl's substitute server for Nusacoin Core builds after having
