...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the nusacoin repository."
  exit 1
fi
...
# See https://github.com/nusacoin/nusacoin/issues/16064
...
echo 'When compiling nusacoind, run `./configure` in the following way:'
echo
