#!/usr/bin/env python3
# Copyright (c) 2013-2018 The Nusacoin Core developers
...
def main():
    ...
    # Filter out hosts with multiple nusacoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple nusacoin ports' % (ip_stats(ips)), file=sys.stderr)
