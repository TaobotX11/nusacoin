# RapidCheck property-based testing for Nusacoin Core

## Concept

Property-based testing is experimentally being added to Nusacoin Core with
...
If RapidCheck is installed, Nusacoin Core will automatically run the
...
3. Configure Nusacoin Core with RapidCheck.

    `cd` to the directory of your local nusacoin repository and run
...
4. Build Nusacoin Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_nusacoin-crypto_gen.o
    CXX      test/test_nusacoin-key_properties.o
    ```
...
That's it! You are now running property-based tests in Nusacoin Core.
