Nusacoin Core version 0.10.4 is now available from:

  <https://nusacoin.org/bin/nusacoin-core-0.10.4/>
...
- #6953 `43c2789` Split nusacoin-tx into its own package
- #6953 `dfe0d4d` Include nusacoin-tx binary on Debian/Ubuntu
