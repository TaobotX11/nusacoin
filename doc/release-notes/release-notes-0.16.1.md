Nusacoin Core version 0.16.1 is now available from:

  <https://nusacoincore.org/bin/nusacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting nusacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure nusacoind processes are cleaned up when tests end (sdaftuar)
