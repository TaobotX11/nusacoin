Nusacoin Core version 0.13.2 is now available from:

  <https://nusacoin.org/bin/nusacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update nusacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nusacoin-tx to create v2 transactions (btcdrak)
