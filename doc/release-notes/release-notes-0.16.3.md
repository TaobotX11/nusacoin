Nusacoin Core version 0.16.3 is now available from:

  <https://nusacoincore.org/bin/nusacoin-core-0.16.3/>
...
been discovered in Nusacoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` nusacoinconsensus: invalid flags error should be set to `nusacoinconsensus_err` (afk11)
