Nusacoin Core version 0.9.4 is now available from:

  https://nusacoin.org/bin/0.9.4/
...
this update is incompatible with the Nusacoin system and could lead to consensus
forks.

Nusacoin Core released binaries from https://nusacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~nusacoin/+archive/ubuntu/nusacoin
- A third-party or self-compiled Nusacoin Core

upgrade to Nusacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
