Nusacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/nusacoin/files/Nusacoin/nusacoin-0.5.4/
...
http://gitorious.org/nusacoin/nusacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Nusacoin-Qt notifications under Growl 1.3.
Increase required age of Nusacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNusacoin properly when installing Nusacoin-Qt over it. (Windows)
