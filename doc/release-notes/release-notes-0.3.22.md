Download URL: https://sourceforge.net/projects/nusacoin/files/Nusacoin/nusacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NUX fee schedule (users still pay 0.01 NUX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #nusacoin00 - #nusacoin99
