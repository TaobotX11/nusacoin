Nusacoin Core version 0.9.2.1 is now available from:

  https://nusacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NUX to 0.01 NUX
...
- Fix "Start nusacoin on system login"
