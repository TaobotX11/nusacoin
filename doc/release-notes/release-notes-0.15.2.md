Nusacoin Core version *0.15.2* is now available from:

  <https://nusacoincore.org/bin/nusacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in nusacoin-tx (TheBlueMatt)
