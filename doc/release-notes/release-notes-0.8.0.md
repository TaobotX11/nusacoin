Nusacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nusacoin/files/Nusacoin/nusacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Nusacoin
...
New/changed settings (command-line or nusacoin.conf file)
--------------------------------------------------------
