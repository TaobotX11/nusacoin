...
This document provides guidelines for internationalization of the Nusacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nusacoin_en.ts` remains unchanged.
