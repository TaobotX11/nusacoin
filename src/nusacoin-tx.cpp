...
static void SetupNusacoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nusacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nusacoin-tx [options] <hex-tx> [commands]  Update hex-encoded nusacoin transaction\n" +
            "or:     nusacoin-tx [options] -create [commands]   Create hex-encoded nusacoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nusacoin transaction
