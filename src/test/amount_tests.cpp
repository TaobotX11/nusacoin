// Copyright (c) 2016-2025 The Nusacoin Core developers
...
BOOST_AUTO_TEST_CASE(BinaryOperatorTest)
{
    ...
    BOOST_CHECK(b >= a);
    BOOST_CHECK(b >= b);
    // a should be 0.00000002 NUX/kvB now
    a += a;
    BOOST_CHECK(a == b);
}
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    CFeeRate feeRate;
    feeRate = CFeeRate(1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000001 NUX/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::NUX_KVB), "0.00000001 NUX/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::NU_VB), "0.001 sat/vB");
}
