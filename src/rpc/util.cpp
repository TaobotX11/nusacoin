...
const std::string EXAMPLE_ADDRESS[2] = {"nu1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "nu1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    return "> nusacoin-cli " + methodname + " " + args + "\n";
}
