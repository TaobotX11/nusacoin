...
/* A AEAD class for ChaCha20-Poly1305@nusacoin.
 *
 ...
 *
 * The chacha20-poly1305@nusacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@nusacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@nusacoin are relatively fast in
