 ...
 */
class NusacoinCore: public QObject
{
    Q_OBJECT
public:
    explicit NusacoinCore(interfaces::Node& node);
...
/** Main Nusacoin application object */
class NusacoinApplication: public QApplication
{
    Q_OBJECT
public:
    ...
    /// Get window identifier of QMainWindow (NusacoinGUI)
...
Q_SIGNALS:
    ...
    void splashFinished();
    void windowShown(NusacoinGUI* window);
