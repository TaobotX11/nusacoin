...
WalletFrame::WalletFrame(const PlatformStyle *_platformStyle, NusacoinGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
    platformStyle(_platformStyle)
{
    ...
    create_wallet_button->setStyleSheet("border-radius: 8px; width: 135px; height: 35px;");
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(gui, &NusacoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
