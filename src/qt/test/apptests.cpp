...
//! Entry point for NusacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &NusacoinApplication::windowShown, this, &AppTests::guiTests);
...
void AppTests::guiTests(NusacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &NusacoinGUI::consoleShown, this, &AppTests::consoleTests);
