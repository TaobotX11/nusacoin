    ...
    mapper(nullptr)
{
    ...
    ui->nusacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->nusacoinAtStartup);
    ...
    ui->nusacoinAtStartup->setToolTip(ui->nusacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->nusacoinAtStartup->setText(ui->nusacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openNusacoinConfButton->setToolTip(ui->openNusacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new NusacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nusacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNusacoinConfButton_clicked()
{
