...
/**
  Nusacoin GUI main class. This class represents the main window of the Nusacoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NusacoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NusacoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~NusacoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a nusacoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
