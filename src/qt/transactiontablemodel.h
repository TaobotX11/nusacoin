...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, NusacoinUnits::SeparatorStyle separators=NusacoinUnits::separatorStandard) const;
