...
/** Nusacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NusacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NusacoinUnits(QObject *parent);

    /** Nusacoin units.
      @note Source: https://en.nusacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NUX,
...
typedef NusacoinUnits::Unit NusacoinUnit;
