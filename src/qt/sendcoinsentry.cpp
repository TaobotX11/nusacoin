    ...
    platformStyle(_platformStyle)
{
    ...
    // normal nusacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying nusacoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &NusacoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
